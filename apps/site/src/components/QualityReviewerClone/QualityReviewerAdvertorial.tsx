...
type QualityReviewerAdvertorialProps = {
  ...
  reducePreRankingScroll?: boolean;
};
...
export default function QualityReviewerAdvertorial({
  ...
  const [openLook, setOpenLook] = useState<number>(
    reducePreRankingScroll ? -1 : 0,
  );
  const [openAvoid, setOpenAvoid] = useState<number>(
    reducePreRankingScroll ? -1 : 0,
  );
  ...
  return (
    <div className="bg-[#ffffff] text-[#4B4F58] font-[family-name:var(--font-arimo)]">
      ...
      <main className="max-w-[950px] mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div
          className={
            reducePreRankingScroll
              ? "mb-6 rounded-xl border border-[#83D221]/60 bg-[#f8fff1] px-4 py-4 shadow-[0_2px_8px_rgba(0,0,0,0.08)] md:px-5"
              : "border-2 border-[#83D221] p-[30px] md:p-[50px] mb-12 bg-white shadow-[0_0_5px_rgba(0,0,0,0.5)]"
          }
        >
          <h2
            className={
              reducePreRankingScroll
                ? "mb-3 text-center font-[family-name:var(--font-oswald)] text-[24px] font-bold text-[#3A3A3A] md:text-[28px]"
                : "font-[family-name:var(--font-oswald)] text-[32px] md:text-[36px] font-bold text-[#3A3A3A] text-center mb-8"
            }
          >
          ...
          >
            {[
              ...
              <li
                ...
                className={
                  reducePreRankingScroll
                    ? "flex items-center gap-2 rounded-lg border border-[#83D221]/35 bg-white px-3 py-2 font-[family-name:var(--font-oswald)] text-[16px] font-bold tracking-wide text-[#3A3A3A] md:text-[18px]"
                    : "flex items-start gap-4 md:gap-5 text-[22px] md:text-[26px] font-bold text-[#3A3A3A] font-[family-name:var(--font-oswald)] tracking-wide"
                }
              >
                <svg
                  className={reducePreRankingScroll ? "shrink-0" : "shrink-0 mt-1"}
                  width={reducePreRankingScroll ? "18" : "28"}
                  height={reducePreRankingScroll ? "18" : "28"}
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="#3A3A3A"
                  strokeWidth="4"
        ...
        <div
          className={
            reducePreRankingScroll ? "mb-8 grid gap-5 md:grid-cols-2" : ""
          }
        >
        <div
          className={
            reducePreRankingScroll
              ? "border-2 border-[#83D221] bg-white p-4 shadow-[0_2px_8px_rgba(0,0,0,0.12)] md:p-5"
              : "border-2 border-[#83D221] p-[30px] md:p-[50px] mb-12 bg-white shadow-[0_0_5px_rgba(0,0,0,0.5)]"
          }
        >
          <h2
            className={
              reducePreRankingScroll
                ? "mb-3 text-center font-[family-name:var(--font-oswald)] text-[26px] font-bold text-[#2aa359] md:text-[30px]"
                : "font-[family-name:var(--font-oswald)] text-[32px] font-bold text-[#2aa359] text-center mb-6"
            }
          >
            What To Look For
          </h2>
          <div className={reducePreRankingScroll ? "flex flex-col" : "flex flex-col gap-2"}>
            <FaqAccordion
              compact={reducePreRankingScroll}
              type="look"
        ...
        <div
          className={
            reducePreRankingScroll
              ? "border-2 border-[#ea1045] bg-white p-4 shadow-[0_2px_8px_rgba(0,0,0,0.12)] md:p-5"
              : "border-2 border-[#ea1045] p-[30px] md:p-[50px] mb-12 bg-white shadow-[0_0_5px_rgba(0,0,0,0.5)]"
          }
        >
          <h2
            className={
              reducePreRankingScroll
                ? "mb-3 text-center font-[family-name:var(--font-oswald)] text-[26px] font-bold text-[#ea1045] md:text-[30px]"
                : "font-[family-name:var(--font-oswald)] text-[32px] font-bold text-[#ea1045] text-center mb-6"
            }
          >
            What To Avoid
          </h2>
