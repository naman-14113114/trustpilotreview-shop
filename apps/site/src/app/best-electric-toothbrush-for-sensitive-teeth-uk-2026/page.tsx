...
export const metadata: Metadata = toothbrushGuideMetadata("best-electric-toothbrush-for-sensitive-teeth-uk-2026");

export default function Page() {
  const guide = getToothbrushGuide("best-electric-toothbrush-for-sensitive-teeth-uk-2026");
