...
export const muuhuHairProduct: RankedProduct = {
  ...
  summary:
    "Muuhu is ranked No. 1 because it gives the clearest buying argument for UK shoppers: a 110,000 RPM high-speed motor, 1,600W power, 3 temperature settings, 3 speed settings, ionic care, intelligent heat control, seven attachments, two Coanda-style auto-wrap curlers, diffuser, smoothing brush, round brush, concentrator, 2-year warranty, 90-day guarantee and official free gifts at £149.",
  description: [
  ...
  pros: [
    ...
    "1,600W, 110,000 RPM brushless motor with 3 temperature settings and 3 speed settings for controlled daily drying.",
