...
export const toothbrushProducts: RankedToothbrushProduct[] = [
  MIROOOO_X_DATASET,
  {
    ...
    cons: [
      ...
      "High £165 Upfront Price: At £165 upfront plus high refill costs, it represents a substantial long-term investment.",
    ],
    review: [
      ...
      "Where it falls behind Miroooo Brush X2 is everyday ergonomics, sound, and ongoing cost. The 14-day battery life requires frequent recharges, the motor runs noticeably loud (>64dB), the plastic handle is heavy (140g), it lacks wall-mounted storage, offers only a 2-year warranty, and the £165 upfront price combined with high recurring cost of iO replacement heads (£8–£12 per head) makes ownership over two years considerably more expensive.",
    ],
  },
  {
    rank: 3,
    ...
    cons: [
      ...
      "Exorbitant £222 Upfront Price: At £222 street price (and £349 RRP), it is the most expensive electric toothbrush in this comparison.",
  ...
  },
  {
    ...
    cons: [
      ...
      "High £160 Upfront Price: At £160 for a stripped-down plastic handle with no OLED display or Bluetooth, it delivers poor value compared to the £69 aluminium Miroooo Brush X2.",
    ...
    review: [
      "The Oral-B iO3 Matt Black retails at £160 as an entry-level option in Oral-B's magnetic micro-vibration system. Featuring the classic round brush head, a 360-degree smart pressure ring that glows green for optimal brushing and red for excess force, 3 cleaning modes, and a hard travel case, it delivers a capable mechanical clean.",
      "However, in stripping down the brush, Oral-B removed the defining smart features of the iO line. The iO3 has no interactive OLED screen (unlike the iO6 at #2), no Bluetooth app coaching for missed zones, no wall-mounted dock, only a standard 2-year warranty, a dated 14-day battery that demands a sluggish 16-hour charge cycle, and locks owners into extortionate £8–£12 iO refill heads. At £160 with a loud 64dB motor, heavy 136g plastic body, no display, and only a 30-day return window, it delivers substantially less daily convenience compared to the premium aluminium Miroooo Brush X2 (£69).",
    ],
  },
];
