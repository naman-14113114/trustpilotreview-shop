...
export const MIROOOO_X_DATASET: RankedToothbrushProduct = {
  ...
  pros: [
    ...
    "Quiet Sound (<50dB): Acoustic magnetic motor operates below 50dB while delivering 32,000 RPM clinical plaque disruption.",
...
export const toothbrushProducts: RankedToothbrushProduct[] = [
  ...
  },
  {
    ...
    noiseLevel: "~54dB (Buzzing vibration)",
    ...
    cons: [
      "Weak Plaque Disruption: Operates on basic 33,000 vibrations without dynamic fluid drive, leaving behind stubborn interdental plaque and tartar.",
      ...
      "Only 2 Basic Modes: Limited to Clean and Everyday Polish; missing dedicated gentle, whitening, or tongue cleaning cycles.",
    ...
    review: [
      "While SURI heavily markets its eco-friendly credentials with cornstarch heads and recyclable castor-oil bristles, its actual dental cleaning performance falls drastically short of expectations for a premium £95+ toothbrush.",
      "Its basic 33,000 vibration motor lacks dynamic acoustic plaque disruption, feeling more like a vibrating manual toothbrush than a professional dental device. Furthermore, UK consumers frequently report fragile heads cracking during use, black mold accumulating behind the magnetic mirror mount, and extortionate replacement head subscription costs (£14.40 per pack) with no free accessories included in the standard £95 box. Without a pressure sensor, companion app, or 90-day trial, SURI is a triumph of green marketing over clinical oral care value.",
    ],
  },
  {
    rank: 5,
