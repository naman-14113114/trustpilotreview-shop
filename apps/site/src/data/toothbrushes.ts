...
export const MIROOOO_X_DATASET: RankedToothbrushProduct = {
  ...
  name: "Miroooo X2",
  brand: "Miroooo",
  image: "/img/toothbrushes/miroooo-x2-ranked-product-box-and-brush.png",
...
export const toothbrushProducts: RankedToothbrushProduct[] = [
  MIROOOO_X_DATASET,
  {
    ...
    review: [
      ...
      "Where it falls behind Miroooo Brush X2 is everyday ergonomics, sound, and ongoing cost. The 14-day battery life requires frequent recharges, the motor runs noticeably loud (>65dB), the plastic handle is heavy (140g), and the high recurring cost of iO replacement heads (£8–£12 per head) makes ownership over two years considerably more expensive.",
    ],
  },
  {
    rank: 3,
    ...
    cons: [
      ...
      "Heavy Composite Handle (~135g): More than double the weight of Miroooo Brush X2's 51g featherlight body.",
      "Poor Durability: Composite plastic casing and internal vibrating shaft are prone to seal wear and motor rattle over time, reducing working lifespan compared to unibody metal.",
    ...
    review: [
      ...
      "However, the value equation is difficult to justify for most UK buyers. The £149+ purchase price is steep, the handle is heavy (135g), and the 14-day battery life feels dated compared to modern 90-day cobalt battery endurance. If luxury countertop aesthetics are your sole priority, it's a solid performer—otherwise, Miroooo Brush X2 offers superior lightweight comfort, battery life, and long-term value.",
    ],
  },
  {
    rank: 4,
  ...
  },
  {
    ...
    review: [
      ...
      "However, in stripping down the brush to hit an entry price tier, Oral-B removed the defining smart features of the iO line. The iO3 has no interactive OLED screen (unlike the iO6 at #2), no Bluetooth app coaching for missed zones, a dated 14-day battery that demands a sluggish 16-hour charge cycle, and locks owners into extortionate £8–£12 iO refill heads. At £65 with a heavy 136g plastic body, no display, and only a 30-day return window, it delivers substantially less daily convenience compared to the premium aluminium Miroooo Brush X2 (£69).",
    ],
  },
];
