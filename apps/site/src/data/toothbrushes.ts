...
export const MIROOOO_X_DATASET: RankedToothbrushProduct = {
  ...
  metrics: [
    ...
    { label: "60+ Day Battery Life", value: 99 },
  ...
  pros: [
    "Ultra Light Weight (51g): Ergonomic 51g aerospace aluminium chassis is exceptionally comfortable in hand and naturally mold-resistant.",
    ...
    "£60.85 Free Gift Bundle: Active promotion includes Magnetic Charging Dock (£24.95), Aluminium Travel Case (£15.95), and 2x DuPont Replacement Heads (£19.95) at zero added cost.",
...
export const toothbrushProducts: RankedToothbrushProduct[] = [
  MIROOOO_X_DATASET,
  {
    ...
    cons: [
      ...
      "Extortionate Long-Term Refill Costs (£8–£12 per head): High ongoing replacement head prices create costly long-term maintenance.",
      "Heavy & Bulky Plastic Handle (135g+): Substantially heavier and thicker in hand than lightweight aluminium sonic brushes.",
  ...
  },
  {
    ...
    cons: [
      ...
      "Limited 14-Day Battery Runtime: Requires bi-weekly charging, far shorter than Miroooo X's 60+ day endurance.",
      "Fragile 2-Pin Glass Charger: The charging glass requires a 2-pin shaver plug and easily collects bathroom residue.",
      "Costly Ongoing C3/W3 Refills: Official Sonicare replacement heads cost upwards of £9 to £12 per head.",
      "No Free Promotional Gifts or 90-Day Guarantee: Zero bonus accessories included in base packages; standard 30-day return window.",
  ...
  },
  {
    ...
    cons: [
      "No Companion App or Smart Guidance: Lacks Bluetooth connectivity, real-time mouth mapping, and smart brushing guidance.",
      "Milder 33,000 VPM Motor: Cleaning action is noticeably softer than 40,000+ VPM acoustic levitation motors.",
      "Expensive £95 Base Price with No Free Gifts: High £95 entry price for the standalone brush with no travel case included (UV case bundle is £115).",
      "Only 2 Basic Speed Modes: Clean and Polish only; lacks dedicated sensitive gum care or deep clean cycles.",
      "Cornstarch Head Fragility: Plant-based heads can fit very tightly or occasionally crack if pushed with excessive force.",
      "Standard 30-Day Return Policy: Standard return window with no extended 90-day trial period.",
    ],
    review: [
  ...
  },
  {
    ...
    cons: [
      "No Smart App Integration: Lacks Bluetooth connectivity, interactive digital coaching, and smart brushing zone tracking.",
      "Obsolete Disposable AAA Battery: Relies on single disposable AAA alkaline batteries instead of modern rechargeable USB-C lithium cells.",
      "Underpowered 15,000 VPM Vibration: Barely vibrates at 15,000 VPM, lacking the acoustic fluid dynamics needed to dislodge plaque between tight teeth.",
      "Zero Free Gifts & Aggressive Subscription Trap: Heavy marketing pushes buyers into expensive recurring £5–£7 head refill subscriptions with zero included accessories.",
      "No Pressure Sensor or Gum Warning: Completely lacks pressure detection or visual alerts to protect sensitive gums from abrasive over-brushing.",
      "Cheap Plastic Housing with Motor Noise: Lightweight internal plastic mechanism prone to motor wear, rattling noise, and moisture intrusion.",
    ],
    review: [
