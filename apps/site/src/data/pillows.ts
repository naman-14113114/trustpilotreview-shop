...
export const pillowProducts: RankedPillowProduct[] = [
  {
    ...
    summary:
      "The RestArch Pillow is the most purpose-built ergonomic cervical pillow available in the UK for 2026. Its generous 68.5 x 37 cm footprint features an anatomical central head cradle, raised cervical neck arch, dedicated shoulder-and-arm recesses, and an ear-pressure relief cavity that eliminates neck stiffness, shoulder impingement, and morning numbness.",
    review: [
      ...
      "Engineered specifically for side and combination sleepers, the RestArch features a <strong>6-Zone Anatomical Contour</strong>. A central concave cradle gently suspends the occipital region, while a reinforced cervical contour maintains the natural lordotic curve of the neck. Most crucially, <strong>sculpted lateral shoulder wings and under-arm rest channels</strong> allow the lower shoulder and arm to rest naturally without compressing nerves or restricting circulation.",
      "Unlike generic 'one-size-fits-all' pillows, RestArch offers two distinct finished heights: <strong>Regular (8.9 cm)</strong> for petite to medium frames and back sleepers, and <strong>High (10.9 cm)</strong> for broader shoulders and dedicated side sleeping. The high-density, slow-rebound molded memory foam core provides consistent, pressure-relieving support night after night without sagging or flattening.",
      "With a genuine <strong>90-Night Risk-Free In-Home Trial</strong>, free tracked UK Royal Mail / DPD delivery, and substantial bundle savings (2 pillows for £88.99, 4 pillows for £151.99), the RestArch Pillow delivers unmatched comfort, therapeutic spine support, and unbeatable value.",
    ],
    metrics: [
    ...
    pros: [
      "Anatomical 6-zone contour: Dedicated zones for head cradle, cervical neck arch, shoulder wings, arm channels, and ear pressure relief.",
      "Two tailored height profiles: Choose Regular (8.9 cm) or High (10.9 cm) for a perfect anatomical fit without messy loose foam shuffling.",
      "Eliminates shoulder numbness & ear pain: Deep side cutaways and central relief basin prevent shoulder crushing and ear cartilage compression.",
  ...
  },
  {
    ...
    pros: [
      ...
      "Affordable entry price: Discounted sale pricing for an entry-level contoured pillow.",
    ],
    cons: [
