(function () {
  ...
  var UK_BUUDY_IPL_URL = "https://www.buudy.co.uk/products/buudy-ipl-hair-removal-device";
  var FALLBACK_BUUDY_URL = UK_BUUDY_IPL_URL;
  var BUUDY_IMAGE_RE = /buudy|ipl|176943060543a303d043|10650730\/products/i;
  var BUUDY_CARD_TEXT_RE = /buudy\s*(ipl|hair|removal|device)|official website|check availability|free gifts/i;
  ...
  function toBuudyHref(rawHref) {
    ...
    try {
      ...
      var normalizedHref = url.href
        .replace(OLD_BUUDY_FACE_MASK_URL, UK_BUUDY_IPL_URL)
        .replace(OLD_BUUDY_LED_MASK_URL, UK_BUUDY_IPL_URL)
        .replace(OLD_UK_BUUDY_LED_MASK_URL, UK_BUUDY_IPL_URL)
        .replace("https://www.buudy.co.uk/products/buudy-led-mask", UK_BUUDY_IPL_URL);
  ...
  // Failsafe tracking for dynamic React link actions
