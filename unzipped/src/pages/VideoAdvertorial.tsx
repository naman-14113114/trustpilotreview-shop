...
const products = [
  {
    ...
    image: "https://www.buudy.co.uk/images/products/buudy-led-mask/02-buudy-led-mask-side-profile.webp",
    price: "£179",
    originalPrice: "£449",
    rating: "4.9 / 5",
  ...
  },
  {
    ...
    pros: [
      ...
      "Clinically Studied: The company provides specific clinical data on its effectiveness for anti-ageing (e.g., \"reducing wrinkles by 30%... in 8 weeks\").",
    ...
    cons: [
      ...
      "Very Limited Treatment Modes: This is an anti-ageing-only device. It only offers 3 red/near-infrared wavelengths and completely lacks the 7 Colour versatility of the Buudy mask. It cannot be used to target acne (Blue light), dark spots (Green light), or redness (Yellow light).",
      "Not a Complete Solution: Because it only targets one concern (ageing), it is not a comprehensive solution for total skin health like a multi-colour mask.",
      ...
      "Silicone Mask Dangers: Recent studies have highlighted potential safety and hygiene concerns with flexible silicone LED Face Masks. <a href='https://www.trustpilotreview.shop/silicone-led-mask-dangers' target='_blank' class='text-red-500 hover:text-red-700 underline font-bold'>Read Full Report</a>"
    ],
    metrics: [
  ...
  },
  {
    ...
    cons: [
      ...
      "Very Limited Treatment Modes: This mask is an anti-ageing device only. It is limited to just 2 light wavelengths (Red and near-infrared) and is missing the 5 other modes (like Blue, Green, and Yellow) that come standard with the Buudy mask.",
  ...
  },
  {
    ...
    isWinner: false,
    description: [
      "The Shark CryoGlow LED Face Mask has quickly made headlines and won prestigious beauty awards since its launch. From a trusted brand known for high-tech innovation, Shark offers the first LED Face Mask featuring integrated under-eye cooling technology, making it a unique 2-in-1 solution for facial care.",
    ...
    pros: [
      "Unique Cooling Technology: Its main selling point is the \"Insta-Chill\" cryo-therapy for the under-eyes, a feature not found in standard LED Face Masks, which helps to soothe and depuff.",
    ...
    cons: [
      ...
      "No Neck Coverage: The device is for the face only and offers no treatment for the neck, a key area of concern for ageing that is included with the Buudy mask.",
  ...
  },
  {
    ...
    description: [
      ...
      "Crucially, at this premium price, it entirely lacks neck and chest coverage. While it does provide convenience, the 162 LEDs offer a lower density of light compared to modern high-output models, and it completely misses out on 5 vital therapeutic colour spectrums needed for comprehensive facial health, making it a pricey option compared to more feature-rich alternatives."
    ],
    pros: [
    ...
    cons: [
      ...
      "Zero Neck & Chest Coverage: For nearly £500, the lack of a neck attachment is a glaring omission. Users risk the \"floating head\" ageing effect, whereas better-value masks include neck and decolletage treatment as a standard feature.",
      ...
      "Severely Limited Colour Spectrum: It offers only 3 modes (Red, Blue, and Combo). It completely misses out on Green (pigmentation), Yellow (redness), Cyan, Purple, and White light therapies that come standard with Buudy.",
...
const productVideos: Record<number, {
  src: string;
  poster: string;
  label: string;
  headline: string;
  ...
  1: {
    ...
    poster: "/videos/buudy-video-thumbnail-megan.png",
    label: "Dermatologist video verdict",
    headline: "Why Buudy is our No. 1 pick",
    copy: "Dr. Megan Vincze highlights the reasons Buudy stands out for home use: full face-and-neck coverage, a 7 Colour light spectrum, 830nm near-infrared support, comfortable eye protection, and a £179 sale price that is far below many premium face-only masks."
  },
  2: {
    src: "/videos/currentbody-verdict.webm",
    poster: "/videos/currentbody-verdict-poster.jpg",
    label: "Dermatologist comparison",
    headline: "Premium feel, but the value gap is clear",
    copy: "CurrentBody has a polished, flexible design and strong brand recognition. The drawback is value: the standard mask is face-only at a much higher price, while full face-and-neck treatment costs substantially more."
  },
  3: {
    src: "/videos/omnilux-verdict.webm",
    poster: "/videos/omnilux-verdict-poster.jpg",
    label: "Dermatologist comparison",
    headline: "Trusted, polished, and still narrowly focused",
    copy: "Omnilux is a credible clinical-style mask, but it remains focused on a narrower red and near-infrared routine. For shoppers wanting multiple light modes and neck coverage in one purchase, the total cost rises quickly."
  },
  4: {
    src: "/videos/shark-verdict.webm",
    poster: "/videos/shark-verdict-poster.jpg",
    label: "Dermatologist comparison",
    headline: "Cooling stands out, but the skincare range is narrower",
    copy: "Shark's under-eye cooling is memorable, but the device is still a face-only mask with fewer light options. It may suit shoppers who prioritise cooling, but it is less complete for broader skin goals."
  },
  5: {
    src: "/videos/dr-dennis-verdict.webm",
    poster: "/videos/dr-dennis-verdict-poster.jpg",
    label: "Dermatologist comparison",
    headline: "Fast treatment, high price, rigid fit",
    copy: "Dr. Dennis Gross offers a very quick treatment window, but the rigid shell, high price, and lack of neck coverage make it harder to recommend as the best everyday buy for most UK shoppers."
  }
};

const ProductVideoVerdict: React.FC<{ productId: number; isWinner?: boolean }> = ({ productId, isWinner }) => {
  ...
  return (
    <div className={`mb-8 overflow-hidden rounded-3xl border shadow-sm ${
      isWinner ? 'border-emerald-200 bg-emerald-50/50' : 'border-slate-200 bg-slate-50'
    }`}>
      <div className="grid grid-cols-1 md:grid-cols-[220px_1fr] lg:grid-cols-[260px_1fr]">
        <div className="relative bg-black">
          <video
            ref={videoRef}
            className="no-fullscreen-video block w-full aspect-[9/16] object-cover"
            controls
          ...
          >
            <source src={video.src} type={video.src.endsWith('.mp4') ? 'video/mp4' : 'video/webm'} />
          ...
          <button
            ...
            onClick={playVideo}
            className={`absolute left-1/2 top-1/2 z-20 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/95 text-emerald-700 shadow-[0_18px_40px_rgba(0,0,0,0.28)] ring-8 ring-white/35 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-emerald-200 ${
              isPlaying ? 'pointer-events-none opacity-0 scale-90' : 'opacity-100 scale-100'
            }`}
          >
        ...
        <div className="flex flex-col justify-center p-6 md:p-8">
          <p className={`mb-3 text-xs font-black uppercase tracking-[0.22em] ${isWinner ? 'text-emerald-700' : 'text-slate-500'}`}>
            {video.label}
          </p>
          <h3 className="mb-4 font-serif text-2xl font-bold leading-tight text-slate-950 md:text-3xl">
            {video.headline}
          </h3>
...
const CriteriaSection = () => (
  <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-200 mt-16 mb-16 max-w-4xl mx-auto">
    ...
    <p className="text-center text-slate-600 bg-slate-50 p-4 rounded-xl border border-slate-100">
      After 200+ hours of hands-on checks, dermatologist input, and review analysis, these five LED Face Mask options stood out for performance, comfort, safety, value, and real-world usability.
    </p>
  </div>
);
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 text-slate-600 mb-10">
            <div className="flex items-center gap-3">
              <img 
                src="/img/dr-megan-vincze-avatar-v2.png" 
                alt="Dr. Megan Vincze" 
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
                ...
                <div className="lg:col-span-8">
                  ...
                  <ProductVideoVerdict productId={product.id} isWinner={product.isWinner} />
          ...
          <div className="bg-[#f8f4e6] rounded-[2rem] p-8 md:p-12 shadow-[0_15px_40px_-10px_rgba(0,0,0,0.1)] border border-[#e8dccb] relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="relative">
                <a href="https://www.buudy.co.uk/products/buudy-led-mask" className="block">
                  <img
                    src="/img/buudy-blue-light-no1-pick.png"
                    alt="Buudy 7 Colour LED Mask blue light mode"
                    className="mx-auto w-full max-w-[420px] rounded-[1.75rem] border border-[#dfd1bd] object-cover shadow-xl transition-transform duration-300 hover:scale-[1.02]"
                  />
                </a>
                <p className="mt-4 text-center text-sm font-medium text-gray-600">
                  Full face-and-neck coverage, 7 Colour support, 830nm near-infrared, and a 90-day money-back guarantee.
                </p>
              </div>
